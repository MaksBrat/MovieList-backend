...
namespace MovieList.Domain.Pagination
{
    /// <summary>
    /// Represents the default implementation of the <see cref="Interfaces.IPagedList{T}"/> interface.
    /// </summary>
    ...
    public class PagedList<T> : IPagedList<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IPagedList{T}" /> class.
        /// </summary>
